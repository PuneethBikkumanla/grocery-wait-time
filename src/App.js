...
import StitchClient from './components/stitchClient'
...
function App() {
  ...
  if (client) {
    return (<LocationSearchInputComponent stitchClient={client}>
      <listOfGroceryStoresComponent stitchClient={client}></listOfGroceryStoresComponent>
